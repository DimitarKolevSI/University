...
ostream & operator<<(ostream & out, const VideoGame & videoGame)
{
	// TODO: insert return statement here
	out << "Name: " << videoGame.Name << endl;
	out << "Creator: " << videoGame.Creator << endl;
	out << "Platform: " << videoGame.Platform << endl;
	out << "Year: " << videoGame.Year << endl;
	out << "Price: " << videoGame.Price << endl;
	out << "Amount: " << videoGame.Amount << endl;
	out << "Rating: " << videoGame.Rating << "/10 from " << videoGame.NumberOfRatings << " ratings.\n";
	return out;
}
