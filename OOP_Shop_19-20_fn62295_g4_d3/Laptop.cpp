...
{
	out << "Brand: " << laptop.Brand << endl;
	out << "Model: " << laptop.Model << endl;
	out << "Category: " << laptop.Category << endl;
	out << "Year: " << laptop.Year << endl;
	out << "Price: " << laptop.Price << endl;
	out << "Amount: " << laptop.Amount << endl;
	out << "Rating: " << laptop.Rating << "/10 from " << laptop.NumberOfRatings << " ratings.\n";
	return out;
}
