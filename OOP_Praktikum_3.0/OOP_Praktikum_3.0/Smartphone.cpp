...
ostream & operator<<(ostream & out, const SmartPhone & smartPhone)
{
	// TODO: insert return statement here
	out << "Brand: " << smartPhone.Brand << endl;
	out << "Model: " << smartPhone.Model << endl;
	out << "Year: " << smartPhone.Year << endl;
	out << "Price: " << smartPhone.Price << endl;
	out << "Amount: " << smartPhone.Amount << endl;
	out << "Rating: " << smartPhone.Rating << "/10 from " << smartPhone.NumberOfRatings << " ratings.\n";
	return out;
}
